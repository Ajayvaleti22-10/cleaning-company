...
import { ArrowRight, Heart, Shield, Leaf, Target, Award, CheckCircle } from 'lucide-react'
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div>
              ...
              <p className="text-slate-600 leading-relaxed mb-4">Today, we serve over 50 happy clients across the metro area. Every team member is carefully vetted, extensively trained, and shares our passion for perfection.</p>
